...
const Login = () => {
  ...
  const submithandler = async (e) => {
    ...
    setLoading(true)
    try {
      const resp = await axios.post(`${API_BASE_URL}/signin`, user)
      if (resp.status === 200) {
      ...
      console.log(error)
      setLoading(false)
      toast.error(error.resp.data.result.message)
    }
  }
    ...
    <div className="mainContainer">
      <div className="signupContainer">
        ...
        <div className="social-account-container">
          ...
          <span className="forgot-password"><Link to='/signup'>Don't have an account please sign-up </Link></span>
